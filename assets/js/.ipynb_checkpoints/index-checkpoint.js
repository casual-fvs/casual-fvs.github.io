...
function change_ablation(case_name) {
    ...
    if(case_name == 'wo_displacement') {
        label1.innerHTML = "w/o view-dependent displacement";
        label2.innerHTML = "w/ view-dependent displacement";
    } else {
        label1.innerHTML = "w/o neighbor blending";
        label2.innerHTML = "w/ neighbor blending";
    }
}
